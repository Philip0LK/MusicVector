...
To stop the program, double-click `停止.cmd` ("Stop") or run `.\停止.cmd`. Closing the browser does not stop the background service; if recognition is running, wait for it to finish or stop it first.
